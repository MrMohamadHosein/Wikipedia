package ir.MrMohamadHosein.wikipedia.fragments
...
import ir.MrMohamadHosein.wikipedia.activity.MainActivity2
import ir.MrMohamadHosein.wikipedia.adapter.ItemEvents
import ir.MrMohamadHosein.wikipedia.adapter.TrendAdapter
import ir.MrMohamadHosein.wikipedia.data.ItemPost
import ir.MrMohamadHosein.wikipedia.databinding.FragmentTrendBinding
import ir.MrMohamadHosein.wikipedia.fragments.SEND_DATA_TO_SECOND_ACTIVITY
...
class FragmentTrend : Fragment(), ItemEvents {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val dataTrend = arrayListOf<ItemPost>(
            ...
            ItemPost(
                "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c6/John_Madden_%28Higher_Quality%29.jpg/220px-John_Madden_%28Higher_Quality%29.jpg",
                "John Madden",
            ...
            ItemPost(
                "https://upload.wikimedia.org/wikipedia/en/thumb/5/5c/Don%27t_Look_Up_2021_film.jpg/220px-Don%27t_Look_Up_2021_film.jpg",
            ...
            ItemPost(
                "https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Their_Mutual_Child_%281920%29_-_3.jpg/220px-Their_Mutual_Child_%281920%29_-_3.jpg",
                "Margaret Campbell",
                "British socialite",
            ...
            ItemPost(
                "https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Eaton_Centre_Boxing_Day%2C_2019.jpg/240px-Eaton_Centre_Boxing_Day%2C_2019.jpg",
                "Boxing Day",
